...
//Mientras sigas introduciendo mas datos 
do {

    //Las ponemos en false
    introducirMasDatos = false;

    datosCorrectos = false;

    //si no se cancela y los datos no son correctos
    while (!cancelarEntrada && !datosCorrectos) {
        do {
            datosCorrectos = false;
            cancelarEntrada = false;
    ...
    //Mientras no se cancela y los datos no son correctos
    while (!cancelarEntrada && !datosCorrectos) {
        do {
            datosCorrectos = false;
            cancelarEntrada = false;
...
//Metemos los datos del objeto edificio en variables
